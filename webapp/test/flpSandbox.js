		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "Listview",
									"targetURL": "#uiListViewProjectlistviewproject-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"uiListViewProjectlistviewproject-display": {
								"semanticObject": "uiListViewProjectlistviewproject",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=ui.ListViewProject.listviewproject",
									"url": sap.ui.require.toUrl("ui/ListViewProject/listviewproject")
								}
							}
						}
					}
